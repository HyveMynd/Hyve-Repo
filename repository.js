...
var Repository = function(tableName, strategy) {
     ...
     * @returns {Promise} A Bluebird promise. Contains the created object when resolved
     */
    repo.create = function (entity) {
        return new Promise(function (resolve) {
            if (!!repo.strategy.create){
                return resolve(repo.strategy.create(repo.tableName, entity));
            } else {
                return reject(new Error('The create function is not implemented.'));
            }
        });
    };
     ...
     * @returns {Promise} A bluebird promise. Contains the number of successful updated entities when resolved.
     */
     ...
     * @returns {Promise} A bluebird promise. Contains the number of successfully removed entities when resolved.
     */
     ...
     * @returns {Promise} A bluebird promise. Contains the entity matching the id when resolved.
     */
     ...
     * @returns {Promise} A bluebird promise. When resolved contains a collection of all entities.
     */
    repo.all = function () {
        return new Promise(function (resolve) {
     ...
     * @returns {Promise} A bluebird promise. When resolved contains the collection of matching entities.
     */
     ...
     * @param predicate an object with keys matching the entity fields to search by.
     * @returns {Promise} A bluebird promise. When resolved contains a single entity matching the predicate.
     */
     ...
     * @returns {Promise} A bluebird promise. When resolved contains the number of entities removed.
     */
    repo.clear = function () {
        return new Promise(function (resolve) {
    ...
    /**
     * Installs the database tables for this repository. Optional function.
     * @returns {Promise} A bluebird promise.
     */
    repo.install = function () {
        return new Promise(function (resolve, reject) {
            if (!!repo.strategy.install){
                return resolve(repo.strategy.install());
            } else {
